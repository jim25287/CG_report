...
plot_venn_0
cat("\n<br>")
cat(" 減重門診客戶:", stat_table[stat_table[["client_type"]] == 2, "id"] %>% pull() %>% unique() %>% length(), "位 \n<br>",
    "控糖門診客戶:", stat_table[stat_table[["client_type"]] == 1, "id"] %>% pull() %>% unique() %>% length(), "位 \n<br>")
```
...
plot_venn_2
cat("\n<br>")
cat(" 總共:", stat_table[stat_table[["client_type"]] == 2, "id"] %>% pull() %>% unique() %>% length() ,"筆 \n<br>",
    "排除:", (stat_table[stat_table[["client_type"]] == 2, "id"] %>% pull() %>% unique() %>% length()) - (Reduce(intersect, list(stat_table[stat_table[["client_type"]] == 2, "id"],
                       ...
                       stat_table[!is.na(stat_table[["note_count"]]), "id"])) %>% pull() %>% length()) , "筆 \n<br>",
