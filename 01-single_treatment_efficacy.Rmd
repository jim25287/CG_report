...
在男性客戶中，100%在療程中實現減重目的(目標設定不同)。其中將近4％表現超乎預期(降幅\>15%)、40％表現優異(降幅\>8%)，40%表現良好(降幅4\~8%)。
...
1.  減重成效與初始狀態(Baseline)無關。

2.  減重成效與飲食紀律有關，且具有統計上顯著差異。

3.  減重成效: 整體具有顯著差異，但HOMA-ß, Lipid profile(TG, TC, LDL),無顯著差異
