SELECT clients.id, clients.name, clients.birthday AS btd, programs.name AS program_name, orgs.name AS org_name, group_classes.started_at AS date_T0, group_classes.finished_at AS date_T1
FROM clients
