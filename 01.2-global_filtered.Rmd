## 分層分析-1(續): 減重成效 {#strat_1_ob_filtered}
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t0_1")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t0_2")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t0_3")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t0_4")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t0_5")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t0_6")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t0_7")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t0_8")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t0_9")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t0_10")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t1_1")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t1_2")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t1_3")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t1_4")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t1_5")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t1_6")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t1_7")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t1_8")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t1_9")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "t1_10")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "diet")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_1")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_2")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_3")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_4")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_5")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_6")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_7")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_8")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_9")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_10")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_p_1")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_p_2")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_p_3")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_p_4")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_p_5")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_p_6")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_p_7")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_p_8")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_p_9")],
          ncol = 2,
...
plot_grid(plotlist = myplots_exclude_record_factor[which(myplot_table_global[["block"]] == "delta_p_10")],
          ncol = 2,
