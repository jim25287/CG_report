...
plot_grid(plotlist = myplots[11:22], ncol = 2, labels = paste0(LETTERS[2], seq(1,10)))
```
...
```{r, results='asis', fig.width= 10, fig.height=20}
plot_grid(plotlist = myplots[23:32], ncol = 2, labels = paste0(LETTERS[3], seq(1,10)))
```

#### **Blood**

```{r, results='asis', fig.width= 10, fig.height=20}
plot_grid(plotlist = myplots[33:44], ncol = 2, labels = paste0(LETTERS[4], seq(1,10)))
```
...
plot_grid(plotlist = myplots[45:61], ncol = 2, labels = paste0(LETTERS[5], seq(1,26)))
```
...
```{r, results='asis', fig.width= 10, fig.height=20}
plot_grid(plotlist = myplots[62:71], ncol = 2, labels = paste0(LETTERS[6], seq(1,10)))
```

#### **成效**(∆)-Blood

```{r, results='asis', fig.width= 10, fig.height=20}
plot_grid(plotlist = myplots[72:83], ncol = 2, labels = paste0(LETTERS[7], seq(1,10)))
```
...
```{r, results='asis', fig.width= 10, fig.height=20}
plot_grid(plotlist = myplots[94:105], ncol = 2, labels = paste0(LETTERS[9], seq(1,10)))
```
...
### 相關分析(Correlation Analysis) {#cor_sua .unnumbered}
