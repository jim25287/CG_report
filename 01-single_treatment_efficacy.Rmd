...
```{r, results='asis', fig.width = 7, fig.height= 7.5, warning=FALSE}
corrplot(M1, 
         p.mat = M_test1$p,
         type = "lower",
         insig = "label_sig",
...
```{r, results='asis', warning=FALSE}
knitr::kable(
  cor_table_02 %>% plot(), caption = 'Correlation: Diet and  Effectiveness',
  booktabs = TRUE
)
```
...
plot_grid(plotlist = myplots[41:62], ncol = 2, labels = paste0(LETTERS[5], seq(1,26)))
```
...
```{r, results='asis', fig.width= 10, fig.height=20}
plot_grid(plotlist = myplots[63:72], ncol = 2, labels = paste0(LETTERS[6], seq(1,10)))
```

#### **成效**(∆)-Blood

```{r, results='asis', fig.width= 10, fig.height=20}
plot_grid(plotlist = myplots[73:82], ncol = 2, labels = paste0(LETTERS[7], seq(1,10)))
```

#### **成效(%)-Inbody**

```{r, results='asis', fig.width= 10, fig.height=20}
plot_grid(plotlist = myplots[83:92], ncol = 2, labels = paste0(LETTERS[8], seq(1,10)))
```

#### **成效(%)-Blood**

```{r, results='asis', fig.width= 10, fig.height=20}
plot_grid(plotlist = myplots[93:102], ncol = 2, labels = paste0(LETTERS[9], seq(1,10)))
```
...
男性荷爾蒙「睪固酮」血中濃度與「體重」、「體脂」，以及「空腹血糖」、「空腹胰島素」和「胰島素抗性」(IR)具有顯著正相關。
...
plot_grid(plotlist = myplots_plot_testosterone[42:63], ncol = 2, labels = paste0(LETTERS[5], seq(1,50)))
```
...
```{r, results='asis', fig.width= 5, fig.height=20}
plot_grid(plotlist = myplots_plot_testosterone[64:73], ncol = 2, labels = paste0(LETTERS[6], seq(1,50)))
```

#### **成效**(∆)-Blood

```{r, results='asis', fig.width= 5, fig.height=20}
plot_grid(plotlist = myplots_plot_testosterone[74:83], ncol = 2, labels = paste0(LETTERS[7], seq(1,50)))
```

#### **成效(%)-Inbody**

```{r, results='asis', fig.width= 5, fig.height=20}
plot_grid(plotlist = myplots_plot_testosterone[84:93], ncol = 2, labels = paste0(LETTERS[8], seq(1,50)))
```

#### **成效(%)-Blood**

```{r, results='asis', fig.width= 5, fig.height=20}
plot_grid(plotlist = myplots_plot_testosterone[94:103], ncol = 2, labels = paste0(LETTERS[9], seq(1,50)))
```
